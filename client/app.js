...
function onClickedRent() {
  ...
  var url = "http://127.0.0.1:5000/rent_price";
  // var url = "/api/predict_home_price"; // Use this if you are using nginx
  ...
  $.post(
    ...
    function (data, status) {
      console.log(data.estimated_price);
      estPrice.innerHTML =
        "<h2>" + data.estimated_price.toFixed(2).toString() + " INR</h2>";
      console.log(status);
    }
  );
}
...
function onPageLoad() {
  ...
  var url = "http://127.0.0.1:5000/get_location_names_rent";
